        ...
        this.createChart('benefitsTypeChart', {
            ...
            data: {
                ...
                datasets: [
                    ...
                    { label: '2025', data: [20941, 909, 202], backgroundColor: colors.purple, borderRadius: 5 }
                ]
            },
            options: {
                ...commonOptions,
    ...
    renderAmmortizzatoriSospensione() {
        ...
        this.createChart('cigHoursChart', {
            ...
            data: {
                ...
                datasets: [
                    { label: 'CIGO', data: [365795, 720750, 681287, 607251], borderColor: colors.sky, tension: 0.3 },
                    { label: 'CIGS', data: [126111, 97009, 437841, 522527], borderColor: colors.pink, tension: 0.3 },
                    { label: 'Fondi Solidarietà', data: [90184, 17793, 4034, 15991], borderColor: colors.green, tension: 0.3 }
                ]
            },
            options: commonOptions
        });
        ...
        this.createChart('cigBeneficiariesChart', {
            ...
            data: {
                labels: ['2024', '2025'],
                datasets: [
                    { label: 'CIGO', data: [7293, 6454], backgroundColor: colors.sky, borderRadius: 5 },
                    { label: 'CIGS', data: [1987, 2261], backgroundColor: colors.pink, borderRadius: 5 },
                    { label: 'Fondi Solidarietà', data: [72, 103], backgroundColor: colors.green, borderRadius: 5 }
                ]
            },
            options: {
                ...commonOptions,
        ...
        this.createChart('erogationTimingChart', {
            ...
            data: {
                labels: ['Pesaro e Urbino', 'Regione Marche', 'Italia'],
                datasets: [
                    { label: 'CIGO (gg)', data: [7, 13, 20], backgroundColor: colors.purple, borderRadius: 5 },
                    { label: 'FIS (gg)', data: [29, 32, 48], backgroundColor: colors.teal, borderRadius: 5 }
                ]
            },
            options: {
                ...commonOptions,
        ...
        if (tabId === 'vigenti') {
            this.createChart('pensionersByTypeChart', {
                ...
                data: {
                    labels: ['Femmine', 'Maschi'],
                    datasets: [
                        { label: 'Pensionati IVS', data: [45640, 43615], backgroundColor: colors.teal, borderRadius: 5 },
                        { label: 'Beneficiari Assistenziali', data: [14892, 9008], backgroundColor: colors.purple, borderRadius: 5 }
                    ]
                },
    ...
    renderAssistenzaInvalidita() {
        ...
        this.createChart('prestazioniVigentiChart', {
            ...
            data: {
                ...
                datasets: [
                    { label: 'Femmine', data: [10239, 3200], backgroundColor: colors.pink, borderRadius: 5 },
                    { label: 'Maschi', data: [6285, 2560], backgroundColor: colors.sky, borderRadius: 5 }
                ]
            },
            options: commonOptions
        });
